...
enter "abc street" as Apt/Suite
enter "street 1" as Street 1
select "Dakota" for County
select "Minnesota" for State
enter "55124" as Zip
click button "Save"
select tab "Insurance Affordability * - Jason Singleton"
select nav "Participants"
click link "New…"
...
click button "Save"
enter "01/01/2027" as Start Date
click button "Save"
select nav "Evidence"
