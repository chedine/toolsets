...
const TARGET_ORIGIN = process.env.TARGET_ORIGIN || "https://api.anthropic.com";
const TARGET_PREFIX = normalizePrefix(process.env.TARGET_PREFIX || "");
...
server.listen(PORT, HOST, () => {
  log(`anthropic relay listening on http://${HOST}:${PORT}`);
